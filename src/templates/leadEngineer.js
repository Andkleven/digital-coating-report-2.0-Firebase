      ...
      pages: [
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: "Blast Media",
              type: "select",
              options: ["Garnet", "Grit", "Aluminum Oxide", "Rubbing"],
              writeOnlyFieldIf: "leadEngineer.data.mediaBlasting"
            },
            {
      ...
      pages: [
        {
          ...
          fields: [
            ...
            {
              label: "Identification Marking Description",
              math: "mathIdentificationMarking"
            },
            {
      ...
      pages: [
        {
          ...
          fields: [
            ...
            {
              writeOnlyFieldIf: "leadEngineer.data.asBuilt",
            ...
            },
            {
              ...
              label: "Handling space pin end min",
              subtext: "Dwg Ref. L2",
              type: "number",
              unit: "mm"
            },
            {
              ...
              label: "Handling space pin end max",
              subtext: "Dwg Ref. L2",
              type: "number",
              unit: "mm"
            },
            {
              ...
              label: "Handling space box end min",
              subtext: "Dwg Ref. L3",
              type: "number",
              unit: "mm"
            },
            {
              ...
              label: "Handling space box end max",
              subtext: "Dwg Ref. L3",
              type: "number",
              unit: "mm"
            },
            {
              ...
              label: "Packer element length min",
              subtext: "Dwg Ref. L4",
              type: "number",
              unit: "mm"
            },
            {
              ...
              label: "Packer element length max",
              subtext: "Dwg Ref. L4",
              type: "number",
              unit: "mm"
            },
            {
              ...
              label: "Packer element length total min",
              subtext: "Dwg Ref. L4",
              type: "number",
              unit: "mm"
            },
            {
              ...
              label: "Packer element length total max",
              subtext: "Dwg Ref. L4",
              type: "number",
              unit: "mm"
            },
            {
              ...
              label: "Packer element length #1 min",
            ...
            },
            {
              ...
              label: "Packer element length #1 max",
              subtext: "Dwg Ref. L4.1",
              type: "number",
              unit: "mm"
            },
            {
              ...
              label: "Packer element length #2 min",
            ...
            },
            {
              ...
              label: "Packer element length #2 max",
              subtext: "Dwg Ref. L4.2",
              type: "number",
              unit: "mm"
            },
            {
              ...
              label: "Packer element length #3 min",
            ...
            },
            {
              ...
              label: "Packer element length #3 max",
              subtext: "Dwg Ref. L4.3",
              type: "number",
              unit: "mm"
            },
            ...
            },
            {
              ...
              label: "End-ring Length min"
            },
            {
              writeOnlyFieldIf: "leadEngineer.data.asBuilt",
              fieldName: "endRingLengthMax",
              label: "End-ring Length max"
            },
            {
              writeOnlyFieldIf: {
                "leadEngineer.data.asBuilt": [
